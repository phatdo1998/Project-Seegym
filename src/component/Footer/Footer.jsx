...
const Footer = () => {
  return (
    <div className="w-full h-[410px] xl:h-[496px] bg-black text-white px-4 md:px-0 overflow-hidden xl:flex xl:justify-center  ">
      <div className=" md:flex md:justify-center md:items-center xl:w-full ">
        <div className="w-397px xl:w-[1224px] relative md:w-[420px] md:px-4 ">
          ...
          <div className="xl:flex xl:justify-center xl:items-center xl:ml-[245px]  z-10 ">
            <div className="flex h-[50px] mt-7 md:text-white xl:w-[1224px] xl:absolute xl:top-[10rem] xl: xl:right-10 xl:left-0 ">
              <BsTwitter
                color="#ccc"
                size="20px"
