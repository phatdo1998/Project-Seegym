    ...
    <>
      <div className=" bg-black overflow-hidden">
        <div className="flex items-center justify-center">
          <div className="w-[1224px] h-[240px] text-white flex items-center justify-center md:justify-start  ">
            <h1 className="md:text-[56px] font-extrabold text-4xl ">
              PERSONAL TRAINERS
            </h1>
          </div>
        </div>
        <div className="w-full md:h-full h-[1090px]  bg-black md:flex md:justify-center md:items-center">
          <div className="w-[1224px] h-[752px] text-white md:grid md:grid-cols-2 md:gap-x-40">
            <div className="flex flex-col justify-center px-4 w-full">
              <h2 className="md:text-3xl text-2xl font-extrabold">
                MATTHEW HERON
              </h2>
              <p className=" font-sans text-[16px] my-5 md:w-[540px] w-[380px]">
              ...
              <p className="font-sans text-[16px] md:w-[540px] w-[380px]">
            ...
            <div className="px-4">
              <img
                src={Matthew}
                alt=""
                className="md:w-[503px] md:h-[750px]  h-[579px] object-cover"
              />
            </div>
          </div>
        </div>
        ...
        <div className="w-full md:h-full h-[1035px]  bg-black md:flex md:justify-center md:items-center">
          <div className="w-[1224px] h-[752px] text-white md:grid md:grid-cols-2 md:gap-x-40">
            <div className="flex flex-col justify-center px-4 w-full">
              <h2 className="md:text-3xl text-2xl font-extrabold">
                INNA GEBROW
