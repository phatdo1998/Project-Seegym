...
const About = () => {
  return (
    <div className="h-[820px] lg:h-[1500px] ">
      <div className=" flex items-center justify-center lg:h-[752px] h-[410px] relative text-white">
        <img src={about} alt="" className="w-full h-full z-0 object-cover" />
        <div className="z-10 absolute top-10 w-[410px] lg:w-[1224px] h-full px-4 lg:pl-0 lg:mt-36 ">
          <div className="">
            <h1 className="text-white font-extrabold lg:text-5md text-[32px]  ">
              {" "}
              ABOUT BRONX
            </h1>
            <p className="w-[400px] lg:w-[505px] mt-10 font-sans lg:mt-20">
              We’re not here to carry you to fitness, we’re here to motivate you
              to carry yourself to your goals.{" "}
            </p>
            <p className="w-[400px] lg:w-[505px] mt-7 font-sans">
            ...
            <div className="mt-10 lg:mt-32 pb-5">
      ...
      <div className="flex items-center justify-center lg:h-[752px] h-[410px]  relative text-white">
        ...
        <div className=" z-10 absolute top-10 w-[410px] lg:w-[1224px] h-full px-4 lg:pl-0 lg:mt-36 lg:ml-[1620px] ">
          <div className="">
            <h1 className="text-white font-extrabold lg:text-5md text-[32px] ">
              {" "}
              CLASSES
            </h1>
            <p className="w-[388px] lg:w-[505px] mt-10 font-sans  ">
            ...
            <p className="w-[388px] lg:w-[505px] mt-7 font-sans ">
